//
//  BusinessNewsContentViewController.m
//  SnipNews
//
...
@interface BusinessNewsContentViewController ()

@end

@implementation BusinessNewsContentViewController
