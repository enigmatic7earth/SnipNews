...
- (void)viewDidLoad {
    ...
    [appSettings setValue:@"Business" forKey:@"currentViewController"]; //29-May-2017_PS addition for checking which fetch method to call in Appdelegate
...
{
    NSUInteger index = ((BusinessNewsContentViewController*) viewController).newsIndex;
...
-(void) setupPageViewController
{
    ...
    _pageViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BusinessPageViewController"];
    _pageViewController.dataSource = self;
    
    BusinessNewsContentViewController *startingViewController = [self viewControllerAtIndex:0];
...
- (BusinessNewsContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    BusinessNewsContentViewController *pageContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"BusinessNewsContentController"];
