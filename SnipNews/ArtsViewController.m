...
- (void)viewDidLoad {
    ...
    [appSettings setValue:@"Arts" forKey:@"currentViewController"]; //29-May-2017_PS addition for checking which fetch method to call in Appdelegate
...
{
    NSUInteger index = ((ArtsNewsContentViewController*) viewController).newsIndex;
...
-(void) loadNews
{
    ...
    NSString * newsFilePath = [NSString stringWithFormat:@"%@",[docDirectory stringByAppendingPathComponent:@"arts"]]; // NewsFile
...
-(void) setupPageViewController
{
    ...
    _pageViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"ArtsPageViewController"];
    _pageViewController.dataSource = self;
    
    ArtsNewsContentViewController *startingViewController = [self viewControllerAtIndex:0];
...
- (ArtsNewsContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    ArtsNewsContentViewController *pageContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"ArtsNewsContentController"];
    //pageContentViewController.newsArticleImage = self.pageImage[index];
